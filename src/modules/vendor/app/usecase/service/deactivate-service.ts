...
class DeActivateService {
    ...
    private deactivateService: (data: {serviceId: string,ownerId: string}) => Promise<Output>
    private repository : IRepository

    constructor(dependencies: Dependencies) {
        this.deactivateService = dependencies.deactivateService
    ...
    async execute(data: Input): Promise<Output> {
        ...
        try {
            ...
            const updated = await this.deactivateService({...data,ownerId:vendor._id})
            return {
            ...
            return {
                response: { message: "Error de-activating service" },
...
interface Dependencies {
    deactivateService (data: {serviceId: string,ownerId: string}) : Promise<Output>
